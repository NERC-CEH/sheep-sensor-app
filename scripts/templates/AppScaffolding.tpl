<div id="sheep-pollutant">
  <div class="well">
    <h2>Pollution event status</h2>
    <h4>Here are the chances of pollution events</h4>
    <div class="row">
      <div id="currentGauge" class="col-lg-5"></div>
      <div id="currentChart" class="col-lg-6"></div>
    </div>
  <div class="row">
    <div id="forecastGauge" class="col-lg-5"></div>
  ...
  <div class="well">
    ...
    <div class="row">
      ...
      <div id="rainfall" class="col-lg-6"></div>
    </div>
    <div class="row">
      <div id="moisture" class="col-lg-6"></div>
      <div id="forecasts" class="col-lg-6"></div>
    </div>
  </div>

  <div class="well">
    <h2>Demo of embedding Thingspeak</h4>
    <div class="row">
      <div class="col-lg-6">
